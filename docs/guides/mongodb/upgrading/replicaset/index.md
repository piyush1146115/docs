...
```bash
$ kubectl create -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/guides/mongodb/upgrading/replicaset/yamls/mg-replicaset.yaml
...
```bash
$ kubectl apply -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/guides/mongodb/upgrading/replicaset/yamls/mops-upgrade-replicaset .yaml
