...
```bash
$ kubectl create -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/guides/mongodb/autoscaler/compute/replicaset/yamls/mg-sh.yaml
...
```bash
$ kubectl apply -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/guides/mongodb/autoscaler/compute/sharding/yamls/mg-as-sh.yaml
