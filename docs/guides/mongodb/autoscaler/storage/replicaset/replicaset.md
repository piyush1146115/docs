...
```bash
$ kubectl create -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/guides/mongodb/autoscaler/storage/replicaset/yamls/mg-rs.yaml
...
```bash
$ kubectl apply -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/guides/mongodb/autoscaler/storage/replicaset/yamls/mg-as-rs.yaml
