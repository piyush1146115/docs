...
```bash
$ kubectl create -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/guides/mongodb/volume-expansion/replicaset/yamls/mg-replicaset.yaml
...
```bash
$ kubectl apply -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/guides/mongodb/volume-expansion/repliaset/yamls/mops-volume-exp-replicaset.yaml
