...
```bash
$ kubectl create -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/guides/mongodb/volume-expansion/sharding/yamls/mg-shard.yaml
...
```bash
$ kubectl apply -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/guides/mongodb/volume-expansion/sharding/yamls/mops-volume-exp-shard.yaml
