...
```bash
$ kubectl create -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/guides/mongodb/volume-expansion/standalone/yamls/mg-standalone.yaml
...
```bash
$ kubectl apply -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/guides/mongodb/volume-expansion/standalone/yamls/mops-volume-exp-standalone.yaml
