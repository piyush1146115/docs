...
```bash
$ kubectl apply -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/guides/mongodb/monitoring/using-builtin-prometheus/yamls/builtin-prom-mgo.yaml
...
```bash
$ kubectl apply -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/guides/mongodb/monitoring/builtin-prometheus/yamls/prom-config.yaml
