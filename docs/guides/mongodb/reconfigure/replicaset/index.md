...
```bash
$ kubectl create -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/guides/mongodb/reconfigure/replicaset/yamls/mg-replicaset-config.yaml
...
```bash
$ kubectl apply -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/guides/mongodb/reconfigure/replicaset/yamls/mops-reconfigure-replicaset.yaml
...
```bash
$ kubectl apply -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/guides/mongodb/reconfigure/replicaset/yamls/mops-reconfigure-inline-replicaset.yaml
