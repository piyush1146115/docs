...
```bash
$ kubectl create -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/guides/mongodb/reconfigure/sharding/yamls/mg-shard-config.yaml
...
```bash
$ kubectl apply -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/guides/mongodb/reconfigure/sharding/yamls/mops-reconfigure-shard.yaml
...
```bash
$ kubectl apply -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/guides/mongodb/reconfigure/sharding/yamls/mops-reconfigure-inline-shard.yaml
