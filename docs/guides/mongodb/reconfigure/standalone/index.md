...
```bash
$ kubectl create -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/guides/mongodb/reconfigure/standalone/yamls/mg-standalone-config.yaml
...
```bash
$ kubectl apply -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/guides/mongodb/reconfigure/standalone/yamls/mops-reconfigure-standalone.yaml
...
```bash
$ kubectl apply -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/guides/mongodb/reconfigure/standalone/yamls/mops-reconfigure-inline-standalone.yaml
