...
```bash
$ kubectl create -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/guides/mongodb/scaling/horizontal-scaling/sharding/yamls/mg-shard.yaml
...
```bash
$ kubectl apply -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/guides/mongodb/scaling/horizontal-scaling/sharding/yamls/mops-hscale-up-shard.yaml
...
```bash
$ kubectl apply -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/guides/mongodb/scaling/horizontal-scaling/sharding/yamls/mops-hscale-down-shard.yaml
