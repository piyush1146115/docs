...
```bash
$ kubectl create -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/guides/mongodb/scaling/horizontal-scaling/replicaset/yamls/mg-replicaset.yaml
...
```bash
$ kubectl apply -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/guides/mongodb/scaling/horizontal-scaling/replicaset/yamls/mops-hscale-up-replicaset.yaml
...
```bash
$ kubectl apply -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/guides/mongodb/scaling/horizontal-scaling/replicaset/yamls/mops-hscale-down-replicaset.yaml
